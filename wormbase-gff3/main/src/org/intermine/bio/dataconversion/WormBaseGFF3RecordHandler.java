...
/**
 * Handle special cases when converting WormBase GFF3 files.
 *
 * @author Todd Harris
 */

public class WormBaseGFF3RecordHandler extends GFF3RecordHandler
{
    /**
     * Create a new WormBaseGFF3RecordHandler object.
     * @param tgtModel the target Model
     */
    public WormBaseGFF3RecordHandler(Model tgtModel) {
        super(tgtModel);
